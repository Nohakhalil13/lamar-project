...
export const metadata = {
  ...
  description:
    "Leer LAMAR Stukadoor en Onderhoud kennen: vakmanschap in stucwerk, afwerking en renovatie met meer dan 200 voltooide projecten in Nederland.",
...
function PrincipleCard({ item, idx }: { item: Principle; idx: number }) {
  // التبادل بين الـ Emerald والـ Plum لأرقام العناصر
  const colors = [
    "var(--emerald)",
    "var(--plum)",
    "var(--emerald)",
  ...
  const bgBadge =
    idx % 2 === 0 ? "rgba(46, 90, 68, 0.1)" : "rgba(74, 42, 79, 0.1)";
  const borderBadge =
    idx % 2 === 0 ? "rgba(46, 90, 68, 0.25)" : "rgba(74, 42, 79, 0.25)";
    ...
    <>
      ...
      <main>
        ...
        >
          <div
            className="rv"
            style={{ maxWidth: 1000, margin: "0 auto", padding: "4rem 1.5rem" }}
          >
            <div
              style={{
                display: "grid",
          ...
          <div className="rv" style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            >
              <div>
                ...
                >
                  Van kleine reparaties tot complete renovaties — wij leveren
                  altijd topkwaliteit. Onze klanten beoordelen ons gemiddeld met
                  een 4.9 op Google.
                </p>
